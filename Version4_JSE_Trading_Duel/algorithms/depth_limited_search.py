"""Depth-limited minimax with heuristic for JSE Trading Duel."""


def depth_limited_search(game, depth_limit, evaluator, use_ordering=False, move_orderer=None):
    """Returns (best_action, score, nodes, pruned)."""
    nodes  = [0]
    pruned = [0]
